...
function urlSlug(title) {
  ...
  let splitTitle = split(localTitle);
  //console.log(splitTitle);
  //let slugTitle = slug(splitTitle);
  //console.log(slugTitle);  
  return slug(splitTitle);
}

function split(title) {
    let localTitle = title.trim();
    return localTitle.split(/[\s,-.]+/);
}

function slug(splitArr) {
    let localsplitArr = splitArr;
